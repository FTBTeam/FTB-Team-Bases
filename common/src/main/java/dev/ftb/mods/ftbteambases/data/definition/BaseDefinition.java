                             ...
                             XZ extents)
{
    ...
    public void toBytes(FriendlyByteBuf buf) {
        ...
        buf.writeOptional(exactSpawn, FriendlyByteBuf::writeBlockPos);
    ...
    public static BaseDefinition fromBytes(FriendlyByteBuf buf) {
        ...
        Optional<BlockPos> exactSpawn = buf.readOptional(FriendlyByteBuf::readBlockPos);
        ...
        return new BaseDefinition(id, desc, author, spawnOffset, exactSpawn, devMode, previewImage, displayOrder, dimensionSettings, type, extents);
    }
