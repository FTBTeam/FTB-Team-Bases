...
public record DisplaySettings(String description, String author, Optional<Identifier> previewImage, int displayOrder, boolean devMode) {
    public static final Codec<DisplaySettings> CODEC = RecordCodecBuilder.create(builder -> builder.group(
            ...
            Identifier.CODEC.optionalFieldOf("preview_image").forGetter(DisplaySettings::previewImage),
    ...
    public static final StreamCodec<FriendlyByteBuf, DisplaySettings> STREAM_CODEC = StreamCodec.composite(
            ...
            ByteBufCodecs.optional(Identifier.STREAM_CODEC), DisplaySettings::previewImage,
