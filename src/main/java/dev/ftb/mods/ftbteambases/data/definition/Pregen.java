...
public record Pregen(String templateId, List<Identifier> structureSetIds) implements INetworkWritable<Pregen>, StructureSetProvider {
    public static final Codec<Pregen> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Identifier.CODEC.listOf().fieldOf("structure_sets")
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, Pregen> STREAM_CODEC = StreamCodec.composite(
            ...
            Identifier.STREAM_CODEC.apply(ByteBufCodecs.list()), Pregen::structureSetIds,
            Pregen::new
    );
